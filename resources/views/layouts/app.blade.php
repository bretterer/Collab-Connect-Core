                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative"
                            ...
                            <button class="relative rounded-full p-2 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:hover:text-gray-300"
                                ...
                                <!-- Notification badge -->
                                <span
                                      class="absolute right-0 top-0 block h-2 w-2 rounded-full bg-red-400 ring-2 ring-white dark:ring-gray-800"></span>
                            </button>
                            ...
                            <div class="absolute right-0 z-50 mt-2 w-80 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-800"
                                ...
                                <div class="py-1">
                                    ...
                                    <div class="max-h-64 overflow-y-auto">
                                        ...
                                        <a class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="#">
                                    ...
                                    <div class="border-t border-gray-200 px-4 py-2 dark:border-gray-700">
                                        <a class="text-xs text-blue-600 hover:text-blue-500 dark:text-blue-400"
