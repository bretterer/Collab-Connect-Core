                ...
                <div class="flex-1">
                    <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                        <div>
                            ...
                            <flux:text class="text-gray-600 dark:text-gray-400 mb-2">{{ $user->email }}</flux:text>
                                    ...
                                    <div class="pb-4 border-b border-gray-200 dark:border-gray-700 last:border-0">
                                        <div class="flex items-start justify-between mb-2">
                                            <div>
                                                ...
                                                <flux:text class="text-sm text-gray-600 dark:text-gray-400">{{ $application->campaign->name }}</flux:text>
                                            </div>
