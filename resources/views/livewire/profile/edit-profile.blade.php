                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Business Members</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Add team members who can manage this influencer profile</p>
                            </div>
                        </div>
