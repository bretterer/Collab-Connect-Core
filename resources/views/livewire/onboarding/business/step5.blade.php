...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <flux:button class="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-8 py-3">
            🚀 Create Your First Campaign
        </flux:button>
        <flux:button variant="outline" class="px-8 py-3">
            🔍 Browse Influencers
        </flux:button>
    </div>
