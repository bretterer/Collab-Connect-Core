            ...
            @if($activeTab === 'profile')
                <div class="space-y-8">
                    ...
                    <x-purchase-credits-modal
                        ...
                        title="Purchase Promotion Credits"
                        description="Promotion credits allow you to boost your profile visibility in search results for 1 week per credit."
                        credit-description="Each credit promotes your profile for 1 week."
                        :unit-amount="$this->promoCreditPrice?->stripePrice->unit_amount ?? 0"
                        :quantity="$creditQuantity"
                        quantity-model="creditQuantity"
                        purchase-action="purchasePromotionCredits"
                        :has-price="(bool) $this->promoCreditPrice"
                        unavailable-message="Promotion credit pricing is currently unavailable. Please try again later."
                    />
