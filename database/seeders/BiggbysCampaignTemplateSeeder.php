...
class BiggbysCampaignTemplateSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // Create the BIGGBY campaign using CampaignService
        $campaignData = [
            // Core campaign data
            'campaign_goal' => 'increase brand awareness and drive community connection by highlighting moments that BIGGBY® makes better',
            'campaign_type' => CampaignType::USER_GENERATED,
            'target_zip_code' => '48823',
            'target_area' => 'East Lansing, Michigan',
            'campaign_description' => 'Show how BIGGBY® makes any moment better through authentic storytelling.',
            'influencer_count' => 5,
            ...
            // Brief information
            'project_name' => 'BIGGBY Coffee Creator Brief',
            'main_contact' => 'Rita - Marketing Manager',
            'campaign_objective' => 'Show how BIGGBY® makes any moment/day/routine better',
            ...
            'fan_motivator' => 'Every time I go to BIGGBY® I know I\'m going to leave feeling better/my day will be better than when I walked in (or drove up)',
            'creative_connection' => 'Everyone has a BIGGBY® story. Highlight those "moments" BIGGBY® can make (an occasion, a feeling, an action or a story) better. Examples: A reassuring ritual: you and a friend hitting a BIGGBY® after the gym. An occasion: Reuniting with an old friend or going shopping with your mom. A feeling: Needing a little mood uplift after working remote from your basement office all day long. A story: recovering after scoring a goal on your own net.',
            ...
            'brand_guidelines' => 'Use playful, approachable, positive and thoughtful tone. Tag @biggbycoffee and use #BIGGBYMakesItBetter',
        ...
        $this->command->info('This demonstrates how a comprehensive campaign brief like the BIGGBY template can be created in the system.');
    }
}